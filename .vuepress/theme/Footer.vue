    ...
    <b-container fluid class="footer">
                ...
                <b-row>
                    ...
                    <b-col lg="4">
                        <b-list-group flush>
                            ...
                            <b-list-group-item href="https://top1st.github.io/erc20-generator/" target="_blank" class="text-warning">
                                Create ERC20 Token
                            </b-list-group-item>
                        </b-list-group>
                    </b-col>
            ...
            <b-col lg="12" xl="8" offset-xl="2">
                ...
                <b-list-group flush>
                    <b-list-group-item>
                        <small>
                            created by
                            <b-link class="text-warning" href="https://top1st.github.io/" target="_blank">
                                top1st
                            </b-link>
                        </small>
                    </b-list-group-item>
        ...
        <b-modal id="modal-terms"
            ...
            <b-embed
                    type="iframe"
                    aspect="4by3"
                    src="https://top1st.github.io/bep20-generator-terms/"
